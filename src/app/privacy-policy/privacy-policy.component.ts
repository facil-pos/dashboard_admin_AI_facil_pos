  ...
  setContent(language: string) {
    if (language === 'es') {
      this.content = {
        ...
        useOfInfoText:
          'La información recopilada a través del historial de chats se utiliza para:',
        improveServices:
        ...
        storageDetail:
          'El historial de chats se almacena en Google Dialogflow CX.',
        security: 'Seguridad:',
        securityText:
          'Implementamos medidas de seguridad adecuadas para proteger el historial de chats almacenado. Dado que la información no está asociada a usuarios individuales, minimizamos los riesgos relacionados con la privacidad.',
      ...
      this.content = {
        ...
        introductionText:
          'At Facil Pos, we respect your privacy and are committed to protecting your personal information. This Privacy Policy describes how we collect, use, and protect the information related to the use of our technical support application, Chat Soporte Facil Pos.',
        information: '2. Information We Collect',
        oauth: 'OAuth for Dialogflow:',
        oauthText:
          'We use OAuth to allow users to access our application through Dialogflow. We do not collect personal information beyond what is necessary to perform the OAuth authentication.',
        ...
        useOfInfoText:
          'The information collected through chat history is used to:',
        ...
        storage: '4. Storage and Security of Information',
        storageText: 'Storage:',
        storageDetail: 'Chat history is stored in Google Dialogflow CX.',
        security: 'Security:',
        securityText:
          'We implement appropriate security measures to protect the stored chat history. Since the information is not associated with individual users, we minimize privacy-related risks.',
        ...
        changesText:
          'We reserve the right to update this Privacy Policy at any time. We will notify users of any changes by posting the new policy on this page. We encourage you to review this Privacy Policy periodically to stay informed about how we protect your information.',
        contact: '7. Contact',
        contactText:
